  ...
  ({ className, variant, size, asChild = false, loading = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        {...props}>
        {loading ?
          <svg width={20} role="status" className={`inline mr-2  text-green-200 animate-spin dark:text-[#717171] ${size}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
