  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring  disabled:opacity-40 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        outline:
          "border  border-input bg-white-off text-dark-800 shadow-sm hover:bg-white-off/90  hover:text-black dark:bg-dark-300 dark:text-muted dark:border-muted hover:dark:bg-white-off  dark:hover:text-black dark:hover:border-black",
        secondary:
