    ...
    return (
        <div className="bg-white grid grid-cols-2 p-2 rounded-md">
            ...
            <div className="relative">
                {desconto > 0 && (
                    <div className="absolute -top-1 right-0 text-white bg-red-600 px-2 py-1 transform translate-x-1/2">
                        ...
                        {/* Simulação do pseudo-elemento ::before */}
            ...
            <div className=' col-span-2'>
                ...
                {desconto == 0 &&
                    <span className='uppercase text-muted font-semibold text-sm'>
                        a partir de:
                ...
                {desconto > 0 &&
                    <div className='flex flex-col'>
                        <span className='uppercase text-muted font-semibold text-sm'>
                            de: <span className='line-through text-red-700'>R$ {valor.toFixed(2)}</span>
                        </span>
                        <span className='uppercase text-muted font-semibold text-sm'>
                            por a partir de:
                            <span className='text-primary text-base ml-1'>
